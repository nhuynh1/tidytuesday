...
nh_theme <- theme(panel.background = element_rect(fill = "white"),
          ...
          plot.title = element_text(size = 15, color = "grey15", face = "bold", margin = margin(l = 1, b = 0.5, unit = "cm")),
          plot.subtitle = element_text(size = 12, color = "grey30", margin = margin(l = 1, b = 0, unit = "cm")),
